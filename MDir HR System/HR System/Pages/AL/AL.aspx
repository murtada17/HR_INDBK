<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MDirMaster.Master" AutoEventWireup="true" CodeBehind="AL.aspx.cs" Inherits="HR_Salaries.Pages.AL.AL" %>
                    ...
                    <SortedDescendingHeaderStyle BackColor="#00547E"></SortedDescendingHeaderStyle>
                        ...
                        <div class="row">    <div class="col-6 col-md-3">
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <asp:DropDownList ID="TITLE" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1" AutoPostBack="false"></asp:DropDownList>
                        ...
                        <div class="row">   <div class="col-6 col-md-3">
                            ...
                            <div class="col-6 col-md-3">
                                <asp:DropDownList ID="CLIENT_COUNTRY" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1" AutoPostBack="false"></asp:DropDownList>
                            </div>
                        ...
                        <div class="row">    
                            ...
                            <div class="col-6 col-md-3">
                                <asp:DropDownList ID="CLIENT_LANGUAGE" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1" AutoPostBack="false"></asp:DropDownList>
                            </div>    
                            <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" Width="100%" ID="Label24" runat="server"  Text="NATIONALITY" ForeColor="Red"></asp:Label>
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:DropDownList ID="NATIONALITY" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1" AutoPostBack="false"></asp:DropDownList>
                            </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="EMPLOYMENT_STATUS" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1" AutoPostBack="false"></asp:DropDownList>
                                </div>
                                <div class="col-6 col-md-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="EMPLOYMENT_POSITION" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" AutoPostBack="false"></asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="WORKING_SECTOR" runat="server"  CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" AutoPostBack="false"></asp:DropDownList>
                                </div>
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="RISK_GROUP" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" AutoPostBack="false"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6 col-md-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="EXTENTION_FLAG" runat="server"  CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" AutoPostBack="false"></asp:DropDownList>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="LIMIT_CURRENCY" runat="server"  CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1" AutoPostBack="false"></asp:DropDownList>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="SETTLEMENT_METHOD" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1" AutoPostBack="false"></asp:DropDownList>
                                </div>
                                <div class="col-6 col-md-3">
                                    <asp:Label CssClass="lbl" Width="100%" ID="Label58" runat="server" Text="CLIENT_LEVEL" ForeColor="Red"></asp:Label>
                                </div>
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="CLIENT_LEVEL" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1" AutoPostBack="false"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6 col-md-3">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="BILLING_LEVEL" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1" AutoPostBack="false"></asp:DropDownList>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-3">
                                <asp:DropDownList ID="RESIDENCE_STATUS" runat="server"  CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1" AutoPostBack="false"></asp:DropDownList></div>
                            <div class="col-6 col-md-3">
                        ...
                        <div class="row">   <div class="col-6 col-md-3">
                            ...
                            <div class="col-6 col-md-3">
                                <asp:DropDownList ID="INCOME" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" AutoPostBack="false"></asp:DropDownList></div>
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="SECURE_REGISTRATION_INDICATOT" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" AutoPostBack="false"></asp:DropDownList>
                                </div>
                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-6 col-md-3">
                                            <asp:DropDownList ID="CMO_REGISTRATION_INDICATOR" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" AutoPostBack="false"></asp:DropDownList>
                                        </div>
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="COM_STIKER_REGISTRATION_INDICATRO" runat="server"  CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" AutoPostBack="false"></asp:DropDownList>
                                </div>
                                <div class="col-6 col-md-3">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="STICKER_CARD" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%"  AutoPostBack="false"></asp:DropDownList>
                                </div>
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="DELIVERY_METHOD" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1"  AutoPostBack="false"></asp:DropDownList>
                                </div>
                                        </div>
...
<div class="row">
                                <div class="col-6 col-md-3">
                                    <asp:Label CssClass="lbl" Width="100%" ID="Label96" runat="server" Text="IBAN"></asp:Label>
                                </div>
                                <div class="col-6 col-md-3">
                                    <asp:TextBox CssClass="txt" ID="IBAN" runat="server" Width="100%"></asp:TextBox>
                                </div>
                                <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" Width="100%" ID="Label97" runat="server" Text="Deduction of advances"></asp:Label>
                                </div>
                                <div class="col-6 col-md-3">
