<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MDirMaster.Master" AutoEventWireup="true" CodeBehind="AD_out.aspx.cs" Inherits="HR_Salaries.Pages.AL.AD_out" %>
            ...
            <div class="col-lg-13">
                <div class="sub-content">
                    ...
                    <SortedDescendingHeaderStyle BackColor="#00547E"></SortedDescendingHeaderStyle>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" ID="Label123" runat="server" Width="100%" Text="LAST_NAME" ></asp:Label>
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" ID="LAST_NAME" runat="server" Width="100%" MaxLength="25" TabIndex="1"></asp:TextBox>
                            </div>


                            <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" ID="Label4" runat="server" Width="100%" Text="FIRST_NAME" ></asp:Label>
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" ID="FIRST_NAME" runat="server" Width="100%" MaxLength="15" TabIndex="1"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" ID="FATHER_NAME" runat="server" Width="100%" MaxLength="20" AutoPostBack="true"></asp:TextBox>
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" ID="Label5" runat="server" Width="100%" Text="SHORT_NAME"></asp:Label>
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" ID="SHORT_NAME" runat="server" Width="100%" MaxLength="20" AutoPostBack="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">    
                            <div class="col-6 col-md-3">
                             ...
                             <div class="row">
                             <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" ID="Label13" runat="server" Width="100%" Text="TEL_PRIVATE"></asp:Label>
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" Width="100%" ID="TEL_PRIVATE" runat="server"  MaxLength="15" TabIndex="1"></asp:TextBox>
                            </div>


                                 <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" ID="Label99" runat="server" Width="100%" Text="PASSPORT_NUMBER" ></asp:Label>
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" Width="100%" ID="PASSPORT_NUMBER" runat="server"  MaxLength="15" TabIndex="1"></asp:TextBox>
                            </div>
                             ...
                             <div class="row">
                             <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" ID="Label100" runat="server" Width="100%" Text="DRIVING_LICENSE"></asp:Label>
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" Width="100%" ID="DRIVING_LICENSE" runat="server"  MaxLength="15" TabIndex="1"></asp:TextBox>
                            </div>

                                <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" ID="Label101" runat="server" Width="100%" Text="BIRTH_DATE" ></asp:Label>
                            </div>
                       
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" ID="BIRTH_DATE" runat="server" Width="100%" TabIndex="1"></asp:TextBox>
                            ...
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" ID="BIRTH_PLACE" runat="server" Width="100%" MaxLength="15"></asp:TextBox>
                                    ...
                                    <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" ID="Label103" runat="server" Width="100%" Text="CLIENT_COUNTRY" ></asp:Label>
                            </div>
                            ...
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" ID="CLIENT_CITY" runat="server" Width="100%" MaxLength="13"></asp:TextBox>
                                 ...
                                 <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" Width="100%" ID="Label105" runat="server"  Text="NATIONALITY" ></asp:Label>
                            </div>
                            <div class="col-6 col-md-3">
                             ...
                             <div class="col-6 col-md-3">
                                ...
                                <div class="col-6 col-md-3">
                                 ...
                                 <div class="col-6 col-md-3">
                                    <asp:Label CssClass="lbl" Width="100%" ID="Label107" runat="server" Text="ADR 2 STREET 1"></asp:Label>
                                </div>
                                <div class="col-6 col-md-3">
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                ...
                                <asp:DropDownList ID="Address_Category_DDL" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1" AutoPostBack="false"></asp:DropDownList>
                                 ...
                                 <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" Width="100%" ID="Label115" runat="server" Text="RESIDENCE_STATUS" ></asp:Label></div>
                            <div class="col-6 col-md-3">
                             ...
                             <div class="row">
                             <div class="col-6 col-md-3">
                                    <asp:Label CssClass="lbl" Width="100%" ID="Label78" runat="server" Text="DELIVERY_METHOD"></asp:Label>
                                </div>
                                <div class="col-6 col-md-3">
                                 ...
                                 <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" ID="Label130" runat="server" Width="100%" Text="TEL_WORK" ></asp:Label>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <asp:TextBox CssClass="txt" ID="Mobile_no_1" runat="server" Width="100%" MaxLength="16"></asp:TextBox>
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:Label CssClass="lbl" Width="100%" ID="Label18" runat="server" Text="Institusion" ForeColor="Red"></asp:Label>
                                </div>
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="institusion_DDL" runat="server" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1"  AutoPostBack="false"></asp:DropDownList>
                                </div>
