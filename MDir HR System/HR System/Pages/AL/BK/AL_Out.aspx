                    ...
                    <SortedDescendingHeaderStyle BackColor="#00547E"></SortedDescendingHeaderStyle>
                        ...
                        <div class="row">    
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                  <asp:TextBox CssClass="txt" Width="100%" ID="CLIENT_BRANCH" runat="server" MaxLength="3" required TabIndex="1" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6 col-md-3">
                        ...
                        <div class="row">   <div class="col-6 col-md-3">
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:TextBox CssClass="txt" ID="DATE_OF_APPLICATION" runat="server" Width="100%" TextMode="Date"></asp:TextBox>
                                </div>
                                <div class="col-6 col-md-3">
