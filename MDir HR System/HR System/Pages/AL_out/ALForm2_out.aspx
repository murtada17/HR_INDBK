<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MDirMaster.Master" AutoEventWireup="true" CodeBehind="ALForm2_out.aspx.cs" Inherits="HR_Salaries.Pages.ALForm2_out" %>
                    ...
                    <div class="sub-content">
                        <div class="list-group">
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                  <asp:TextBox CssClass="txt" Width="100%" ID="CLIENT_BRANCH" runat="server" MaxLength="3" required TabIndex="1"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6 col-md-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="LIMIT_CURRENCY" runat="server" AutoPostBack="True" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1"></asp:DropDownList>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="SETTLEMENT_METHOD" runat="server" AutoPostBack="True" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1"></asp:DropDownList>
                                </div>
                                <div class="col-6 col-md-3">
                                    <asp:Label CssClass="lbl" Width="100%" ID="Label58" runat="server" Text="CLIENT_LEVEL" ForeColor="red"></asp:Label>
                                </div>
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="CLIENT_LEVEL" runat="server" AutoPostBack="True" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6 col-md-3">
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:DropDownList ID="BILLING_LEVEL" runat="server" AutoPostBack="True" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1"></asp:DropDownList>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-3">
                                <asp:DropDownList ID="RESIDENCE_STATUS" runat="server" AutoPostBack="True" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1"></asp:DropDownList></div>
                            <div class="col-6 col-md-3">
