<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MDirMaster.Master" AutoEventWireup="true" CodeBehind="ALForm3_out.aspx.cs" Inherits="HR_Salaries.Pages.ALForm3_out" %>
                    ...
                    <div class="sub-content">
                        <div class="list-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-2">
                                    <asp:Label CssClass="lbl" Width="100%" ID="Label81" runat="server" Text="Institusion Name" ForeColor="red"></asp:Label>
                                </div>
                                <div class="col-6 col-md-2">
                                    <!--<asp:TextBox CssClass="txt" ID="ADDR_LINE_3" runat="server" Width="100%" MaxLength="35"></asp:TextBox>-->
                                    <asp:DropDownList ID="ADDR_LINE_33" runat="server" AutoPostBack="True" CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" TabIndex="1"></asp:DropDownList>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-2">
                                    <asp:Label CssClass="lbl" Width="110%" ID="Label94" runat="server" Text="ADDRESS CLIENT CITY 1"></asp:Label>
                                </div>
                                <div class="col-6 col-md-2">
