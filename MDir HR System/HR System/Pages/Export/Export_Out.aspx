        ...
        <div class="content">
            <div class="container">
                ...
                <div class="col-6 col-md-3">
                                 ...
                                 <asp:DropDownList CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" ID="DLL_TypeExport" runat="server" OnSelectedIndexChanged="DLL_TypeExport_SelectedIndexChanged" Visible="false"></asp:DropDownList>
...
<div class="col-6 col-md-3">
                ...
                <div class="col-6 col-md-3">
                        ...
                        <div class="row">
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" Width="100%" ID="txt_salaryCode" runat="server"></asp:TextBox>
                                
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" Width="100%" ID="Label15" runat="server" Text="رمز الترحيل"></asp:Label>
                            </div>
                            <div class="col-6 col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-3">
                             ...
                             <div class="col-6 col-md-3">               
                                 <asp:DropDownList CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" ID="DLL_TypeExportFile" AutoPostBack="true" runat="server" OnSelectedIndexChanged="DLL_TypeExportFile_SelectedIndexChanged"></asp:DropDownList>
                             </div>

                            <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" Width="100%" ID="Label14" runat="server" Text="Type of Export"></asp:Label>
                                <asp:Label CssClass="lbl" Width="100%" ID="Label2" runat="server" Text="Typ"></asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-3">
                                <asp:DropDownList CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" ID="DDL_TypeOfPayment" runat="server" OnSelectedIndexChanged="DDL_TypeOfPayment_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" Width="100%" ID="Label16" runat="server" Text="Type of Payment"></asp:Label>
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:DropDownList CssClass="btn btn-secondary dropdown-toggle dropdown-toggle-split" Width="100%" ID="DDL_TypeOfPersenteg" runat="server" OnSelectedIndexChanged="DDL_TypeOfPersenteg_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="col-6 col-md-3">
                                <asp:Label CssClass="lbl" Width="100%" ID="Label17" runat="server" Text="Type of Payment"></asp:Label>
                            </div>
                        </div>
