<%@ Page Title="نتائج تقييم الموظفين" Language="C#" MasterPageFile="~/Pages/TBIMaster.Master" AutoEventWireup="true" CodeBehind="EmpRatingResult.aspx.cs" Inherits="HR_Salaries.Pages.Employee.EmpRatingResult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="row" id="divName"  runat="server" style="display:none">
            <div class="columnleft">
                <asp:Label ID="Label7" runat="server" Text="اسم الموظف : "></asp:Label>
            </div>
            <div class="columnRight">
                <asp:TextBox ID="txtNameSearch" runat="server" CssClass="txt"></asp:TextBox>
...
<%--               <asp:CheckBox ID="chk" runat="server" OnCheckedChanged="chkNot_CheckedChanged" Text="غير مقيم" AutoPostBack="true"/>--%>
    ...
    <div class="row" style="border-style:ridge;">
         ...
         <br />
         <asp:Label ID="Label12" runat="server" Text="عدد الموظفين لتقييم مقبول : "></asp:Label>
