<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MDirMaster.Master" AutoEventWireup="true" CodeBehind="EmpTransfare.aspx.cs" Inherits="HR_Salaries.Pages.Employee.EmpTransfare" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:Panel ID="pSearch" runat="server">
        ...
        <div class="row">
            ...
            <div class="columnleft"></div>
            <div class="columnRight">
                <asp:Button style="font-size: unset;" ID="btnGetInfo" runat="server" Text="جلب المعلومات" CssClass="btn" OnClick="btnGetInfo_Click" />
            </div>
        </div>
        <div class="row"></div>
    </asp:Panel>
    ...
    <asp:Panel ID="pEdit" runat="server" Enabled="False" BorderColor="#333333">
        ...
        <div class="row">
            <asp:Button style="font-size: unset;" ID="btnTransfare" runat="server" Text="نقل" CssClass="btn" OnClick="btnSubmit_Click" />
            <asp:Button style="font-size: unset;" ID="btnTempTran" runat="server" CssClass="btn" OnClick="btnSubmit_Click" Text="تنسيب" />
