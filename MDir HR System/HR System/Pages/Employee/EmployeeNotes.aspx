<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/TBIMaster.Master" AutoEventWireup="true" CodeBehind="EmployeeNotes.aspx.cs" Inherits="HR_Salaries.Pages.Employee.EmployeeNotes" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div style="overflow: auto; white-space: nowrap;" align="center">
      ...
      <div class="row">
        <asp:Button ID="btnExcel" runat="server" Text="تحميل الملاحظات" CssClass="btn" OnClick="btnExcel_Click"/>
    </div>
