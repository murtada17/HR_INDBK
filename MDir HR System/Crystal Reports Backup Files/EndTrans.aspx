<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MDirMaster.Master" AutoEventWireup="true" CodeBehind="EndTrans.aspx.cs" Inherits="MDir_DMS.Pages.Employee.EndTrans" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="row">
        <asp:Button ID="btnEndTempTrans" runat="server" Text="إنهاء تنسيب" CssClass="btn" OnClick="btnSubmit_Click" />
        <asp:Button ID="btnEndTrans" runat="server" Text="إلغاء نقل" CssClass="btn" OnClick="btnSubmit_Click" />
